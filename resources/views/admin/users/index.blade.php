...
<div class="container mt-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <form method="POST" action="{{ route('admin.users.destroy', $user->id) }}" onsubmit="return confirm('Tolak dan hapus user ini?')">
                                    @csrf
                                    @method('DELETE')
    ...
    {{-- Sudah diverifikasi --}}
    <h5 class="fw-bold mb-3">Daftar Akun Terverifikasi</h5>
            ...
            <tbody>
                ...
                @foreach (\App\Models\User::where('role', 'staff')->where('is_verified', true)->get() as $verified)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-danger" onclick="showModal({{ $verified->id }}, '{{ $verified->name }}')">
                                Hapus
                            </button>
                        </td>
                    </tr>
...
<script>
    function showModal(id, name) {
        ...
        form.action = '/admin/users/' + id + '/secure-delete'; // Pastikan route ini tersedia
